...
@Component({
  selector: 'app-member-webpage-performance',
  templateUrl: './member-webpage-performance.page.html',
  styleUrls: ['./member-webpage-performance.page.scss'],
})
export class MemberWebpagePerformancePage implements OnInit {
